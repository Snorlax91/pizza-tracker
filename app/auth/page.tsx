        ...
        <div className="bg-slate-800/60 border border-slate-700 rounded-2xl p-4 mb-4">
          ...
          <div className="flex flex-col gap-2">
            <button
              ...
              className="w-full py-2.5 rounded-xl bg-white hover:bg-gray-50 text-slate-900 font-semibold flex items-center justify-center gap-2 disabled:opacity-60 disabled:cursor-not-allowed transition-colors"
            >
              {oauthLoading === 'google' ? (
